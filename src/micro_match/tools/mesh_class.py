...
class Mesh:
    def __init__(
        ...
        v=np.array([]),  # Vertices
        f=np.array([]),  # Faces
        g=np.array([]),  # Geodesic Matrix
        num_eigenvectors=100,  # Number of Eigenvectors and values
        type="",
    ):
        self.__v = v  # Vertices
        self.__f = f  # Faces
